...
const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "The setup is instant — once you provide your URL, Elena.AI begins training automatically. Within minutes, your chatbot is ready to answer real customer queries and continuously improve as it learns.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer:
      "Yes! Elena.AI supports 90+ languages, allowing your chatbot to communicate with customers globally in their preferred language.",
  },
  {
    id: 5,
