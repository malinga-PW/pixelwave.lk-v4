...
export default function MegaMenuContact() {
  const contactLinks = [
    { title: "✉️ Send Message", link: "/contact" },
    { title: "💰 Get a Quote", link: "/contact?quote=true" },
    { title: "📞 Book Consultation", link: "/contact#book" },
    { title: "📍 Office Location", link: "/contact#info" },
                    ...
                    <div className="megamenu_widget_inner">
                      <div className="row">
                        <div className="col-xl-6 col-lg-6 megamenu-col">
                          <div className="megamenu_widget">
                            <ul className="icon_list unordered_list_block">
                              {contactLinks.slice(0, 3).map((item, i) => (
                                <li key={i}>
                                  <Link href={item.link}>
                        ...
                        <div className="col-xl-6 col-lg-6 megamenu-col">
                          <div className="megamenu_widget">
                            <ul className="icon_list unordered_list_block">
                              {contactLinks.slice(3).map((item, i) => (
                                <li key={i}>
                                  <Link href={item.link}>
                                    <span className="icon_list_text">{item.title}</span>
                                  </Link>
                          ...
                          <div className="service_link">
                            <div className="xb-item--inner">
                              ...
                              <p className="xb-item--text">
                                Spend 30 minutes with our AI consultants to identify high-impact automation opportunities.
                              </p>
                            </div>
                            <Link href="/contact#book" className="xb-overlay"></Link>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="megamenu_case">
                    <div className="xb-item--inner">
                      <div className="xb-item--img">
                        <Image src={serviceImg} alt="Contact PixelWave" />
                      </div>
                      <div className="xb-item--holder">
                        ...
                        <p className="xb-item--text">
                          Have questions about pricing, project timelines, or tech stacks? Contact us directly.
                        </p>
